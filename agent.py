...
from arch.utils import device_mapper, albedo, url2image, alphanumeric
...
BLIP_DIR = "/Users/James/Documents/blip-image-captioning-large"
...
def main():
    ...
    V1 = Vision(BLIP_DIR, DEVICE)

    en1 = "Prometheus stole fire from the gods and gave it to man."
    en2 = "Test ABC123"
    db.push([en1, en2])

    lookup1 = db.pull()['documents']
    print(lookup1)

    db.delete(str(000))
    lookup2 = db.pull()['documents']
    print(lookup2)
